...
> My workflow to create a decentralized application begins with writing & deploying a solidity smart contract to a local blockchain (Remix / Ganache). I unit test the contract via Jest or React Testing Library. Next, I plan & create the app backend using Express, frontend with React & Web3 or Ethers.js. Now I deploy the contract to an Ethereum testnet such as Kovan, Ropsten or Rinkeby. I deploy all webapp assets to the interplanetary filesystem (IPFS) & test functionality. Finally, I deploy the contract(s) to Ethereum mainnet.
